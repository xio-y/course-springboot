...
import com.edu.hbpu.course.config.MailService;
...
public class UserController {
    ...
    User login(@RequestBody User u){
        QueryWrapper<User> wrapper=new QueryWrapper<>();
        wrapper.select("username,image,uid,type,email").eq("username",u.getUsername()).eq("password",u.getPassword());
    ...
    @PostMapping("/logout")
    void logout(@RequestBody User u){
